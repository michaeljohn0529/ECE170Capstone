...
\newcommand{\college}{College of Engineering}
\newcommand{\department}{Electrical and Electronics Engineering Department} 
...
\newcommand{\degree}{Electronics Engineering}
...
\newcommand{\documentAdviser}{Cristina P. Dadula, PECE}

\newcommand{\examinerChairTitle}{Dr.} 
\newcommand{\examinerChair}{Mishell D. Lawas, PECE}

% Sort in alphabetically ascending manner the surnames of the examiners
\newcommand{\examinerATitle}{Engr.} 
\newcommand{\examinerA}{Julius Jr. V. Olandria}

\newcommand{\examinerBTitle}{Engr.} 
\newcommand{\examinerB}{Tanya M. Osorio}
...
\newcommand{\deanName}{Diomedes L. Tablo}

\newcommand{\deptChairmanTitle}{Dr.}
\newcommand{\deptChairman}{Noel S. Gunay, REE}
...
\defineAuthor{surname1}{Sanglitan}
\defineAuthor{firstname1}{Benjamin R.}

\defineAuthor{surname2}{Perater}
\defineAuthor{firstname2}{Blaze}

\defineAuthor{surname3}{Ambia}
\defineAuthor{firstname3}{Hashim Monir}

\defineAuthor{surname4}{Tagolanao}
\defineAuthor{firstname4}{Abdul Ghaffar}

\defineAuthor{surname5}{Borja}
\defineAuthor{firstname5}{Glerry Paul}

\newcommand{\thesisSubjectCode}{ECE 199}
\newcommand{\documentTitle}{Insert Your Thesis Title Here} % put tilde (~) between words to indicate non-breaking adjacent words

\newcommand{\keywords}{keyword1, keyword2, keyword3}

\newcommand{\finalDefenseDate}{May 17, 2019} % replace ''\usdate\today'' by your final defense date; you may need to use non-breaking space with the use of tildes (~); if so, do not remove the tildes in order to not break the date
